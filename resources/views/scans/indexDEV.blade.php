                ...
                const infoWindow = new google.maps.InfoWindow({
                    ...
                    Distance: ${
                        scan.user?.profile?.hotel?.lat && scan.user?.profile?.hotel?.lng
                            ? calcDistance(parseFloat(scan.lat), parseFloat(scan.lng),
                                           parseFloat(scan.user.profile.hotel.lat),
                                           parseFloat(scan.user.profile.hotel.lng)) + ' km'
                            : '-'
                    }<br>
                    Type: ${_(scan.type)}<br>
